...
const SearchBar = ({ handleAddStock, watchlist, watchlistId }) => {
  ...
  const renderOption = useCallback((option, index) => (
    <div key={option.label + index} className="list-group-item list-group-item-action active search-list text-decoration-none">
      <img src={option.image} alt={option.name} />
      <div className="search-items justify-content-around align-items-center">
        <li>
          <Link to={`/stockinfo/${option.label}`} className="text-decoration-underline">
