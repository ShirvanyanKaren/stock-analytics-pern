      ...
      <div className="card p-4">
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            ...
            <button type="submit" 
            className="btn btn-light w-100 mt-3 d-flex justify-content-center lign-items-center"
            ...
            <button type="submit"
            className="btn btn-dark w-100 mt-3  d-flex justify-content-center align-items-center"
            onClick={() => handleXAuth()}
            >
